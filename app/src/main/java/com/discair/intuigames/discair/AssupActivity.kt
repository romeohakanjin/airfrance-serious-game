...
import kotlinx.android.synthetic.main.activity_assup.*
import kotlinx.android.synthetic.main.app_bar_assup.*

class AssupActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_assup)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.assup, menu)
        return true
    }
